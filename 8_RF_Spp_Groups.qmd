...
ymd_hms(file.info("./8_RF_Spp_Groups.qmd")$ctime, tz = "America/Los_Angeles")
```
...
ymd_hms(file.info("./8_RF_Spp_Groups.qmd")$atime, tz = "America/Los_Angeles")
```
...
standlist <- clean_paths(r"(C:\RxFire\Regen\Regeneration_2_16Sept24\data\train.csv)")
...
fia_db_path <- clean_paths(r"(C:\RxFire\Regen\Regeneration_2_16Sept24\data\homemade_fvs_db.db)")
...
fpags <- read_csv("C:/RxFire/Regen/Regeneration_2_16Sept24/data/1_Import_Clean.csv", 
                      col_types = "ccc")
...
# con <- dbConnect(RSQLite::SQLite(), "c:/RxFire/Regen/Regeneration_2_16Sept24/data/homemade_fvs_db.db")
