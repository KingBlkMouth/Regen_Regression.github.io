...
ymd_hms(file.info("./7_RF_GroupSpp_and_Counts.qmd")$ctime, tz = "America/Los_Angeles")
```
...
ymd_hms(file.info("./7_RF_GroupSpp_and_Counts.qmd")$atime, tz = "America/Los_Angeles")
```
...
save(rf_yai, file = "./data/7_rf_factors.Rdata")
```


```{r}
load(file = "./data/7_rf_factors.Rdata")
