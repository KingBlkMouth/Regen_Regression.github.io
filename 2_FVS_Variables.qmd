...
```{r}
standlist <- read_csv("./1.5_dbCreation_standlist.csv", 
                      col_types = "ccc")
standlist |> glimpse()
```
...
inputDatabase <- 'C:/RxFire/Regen/Regeneration_2_16Sept24/homemade_fvs_db_17sept24.db'
...
standlist <- read_csv("C:/RxFire/Regen/Regeneration_2_16Sept24/1.5_dbCreation_standlist.csv", 
...
# write_csv(splots_1vis, "C:/RxFire/Regen/Regen_Notes/Subplots_w1visit.csv")
...
# getwd()
# write_csv(training_set, "C:/RxFire/Regen/Regeneration_2_16Sept24/train.csv")
# write_csv(testing_set, "C:/RxFire/Regen/Regeneration_2_16Sept24/test.csv")
# write_csv(standlist, "C:/RxFire/Regen/Regeneration_2_16Sept24/train_and_test.csv")
```
