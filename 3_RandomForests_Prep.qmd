...
standlist <- clean_paths(r"(./train_and_test.csv)")
...
fia_db_path <- clean_paths(r"(./homemade_fvs_db_17sept24.db)")
...
```{r}
fpags <- read_csv("./1_Import_Clean2.csv", 
                      col_types = "ccc")
...
db_path <- "c:/RxFire/Regen/Regeneration_2_16Sept24/homemade_fvs_db_17sept24.db"
```
